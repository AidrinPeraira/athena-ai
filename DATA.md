...
- Why story telling matters? Because it give the listener the following
  ...
  - Impact
  - Memory
- There is always the choice to give an answer or narrate an answer. Choose the latter when needed
- Use it to answer situational & behavioural qns
- Use frameworks (give structure)
...
- Control
  - Don’t lose direction while answering.
...
- Don’t say you are a fresher
- You are a skilled fresher.
- Don’t ask for an overbudget salary package
...
- Why do you need a job?
  ...
  - Shock button experiment?
  -
- What do you expect from the company?
- Why do you want to work for us?
- Why do you want to join our company?
- What kind of work environment do you expect?
  - No mentioning unity. No good team points. It depennds on others and their mindsets. It should be none of your business.
  - Say about an environment that allows you to grow. Not help to grow. Allow to grow. Growth is point one. (growth is salary and promotion)
  - 2 is opportunity to upskill. Training. Certification. Permissions for exams etc.
- Why should / shouldn’t we hire you?
  - Ask them how many people they need to make a full stack production grade microservice scalable web application? Also how long? I did it in 3 months from scratch from a different domain learning along the way.
- Answer to a question you don’t know the answer to.
- What if someone senior dumps his work on you?
  - Manage as possible
  - Escalate only if it affects your work
- How do you handle stress?
  - Find solutions
  - Ask help
  - I love work i don't stress (you don’t stress while at the movies right?)
  - Don’t mention taking breaks
- Why did you leave the past company?
  - Never ever say ill about the previous compnany
  - I worked for a year. Learned a lot. But i wanted to move to place where i can do more. It was limited over there.
  - One year is too short. But this is the only way to answer this question.
- Why students from Brototype ask for a higher package?
  - ??
  - Taking up more responsibility is what we are naturally trained to do so we bring value and expect more.
  - Never compare ourselves with others. (Think of it like being non comparable. We can’t compare apples to oranges. Be that confident)
  - Also we are not a fresher. We have skills. That is why we ask for more package than freshers.
  - Training center without a trainer. That in itself is odd and different. Inherently different.
- Questions based on soft skills.
  - Usually two ways this can go
  1. What if question?
     - hypothetical question asked by HR
     - Ask for more clarity if needed. Don’t hesitate.
  2. Have you ever question?
     - This is based on what the HR thinks we might have experienced
     - If you have one share it
     - If not you can turn it into a hypothetical question. And then answer it as what you would do if you were to face such an issue.
- How to tell no to a stuborn client that hasn’t paid and wants more work added?
...
- For you what is work life balance and how do you maintain it?
  ...
  I manage it by staying organized and knowing when to switch off. That helps me avoid burnout and stay consistent.
- Would you choose friendship or money?
- What is the greatest challenge you have faced in ever in your life?
  - Mention a challenge you solved
  - Or emphasize on the leason learned from the failure
- How will you handle the HR telling you that you are no longer needed AI has taken your job?
- What is the one skill you don’t have? how do you plan to acquire it
- Why should we hire you over someone else with similar technical skills?
- What will you do if another company ofers you another job with higher package in 6 months from now?
- What kind of work environment brings out your worst performance?
- Have you ever taken ownership of something that wasn’t your responsibility?
- What motivates you beyond salary?

- If we hire you today what will be the one thing you will be struggling with in the first three months?
  - This question evaluates self awareness.
- Don’t you think the role is too small for your skills?
- Tell me about a time you disagreed with your manager what did you do?
  - This checks how you professionally handle things?
  - Give up or fight or have conversation to understand
- We have two candidates better than you. Why should we still hire you?
  - ask why you think they are better than me?
  - What makes you think that they are better?
  - Maybe justify or i can improve on the feedback
- If your team member is not working, but takes credit, what will you do?
- Where do you see yourself in 5 years? Will you still be with us?
- If we offer you slightly less than your usual expectation, will you accept?
- You don’t have experience in this tool. Why should we take the risk of hiring you?
- If selected how soon can you join?
  - Ask them when they expect me to join.
  - Tell them you can try to make it.
  - Else give them the closest one
...
- What will you do if another company offers you a higher position and better pay?
  - This question reflects trust and loyalty.
  - Don’t delay the answer.
  - Answer that I will still take the job you are offering.
  - The reason I applied is because I have interest in working in this company. The culture, the growth. Why would I jump for another company just for pay.
- What could be a reason that you will resign from an organisation?
  - This is to understand your priorities.
  - Not colleagues. Not pay. Not culture
...
- From what you know about the company and the work we do here, what is something you'd suggest as an improvement or which aspect will be the first place you'd look for any scope of improvement?
  ...
  - Is he observant
  -
- What would you do if you are stuck and there is no one to help you?
  - Check how we handle crisis
  - Panic or no panic
  - List options, document auctions, problem solving approach,
...
- Offering Low package
  ...
  I learned
  My salary grew from a to b
  I have more skills
  Do you value it only that much ?
- What was your last CTC?
  - Dont hesitate.
  - Politely avoid the answer. No disclosure clause. Or ask if you can avoid sharing that.
  - Or
  - Ask a question. Will my new offer be effected by my skills or my previous package
- We’ll increase your salary after 6 months' probation.
  - this is not specific.
  - not necessarily in the 7th month.
  - you just become eligible for next salary increment.
  - How to handle it
    - “If my performnce is satisfactory during the probation can i expect the salary incremetn to refelct from the 7 month.”
    - “It would be much appreciated if you could add that too the offer letter. also the KPI”
  - Sometimes they might give you a very small namesake increment
    - ask why?
